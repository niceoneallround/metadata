...
model.utils.YAML2Node = function YAML2Node(yaml, props) {
  ...
  if (yaml.obfuscation_context) {
    ...
    // this should be just the id
    if (yaml.obfuscation_context.privacy_algorithm) {
      oc[PN_P.privacyAlgorithm] = yaml.obfuscation_context.privacy_algorithm;
    }
    ...
    if (yaml.obfuscation_context.privacy_algorithm_instance) {
      oc[PN_P.PrivacyAlgorithmInstance] = yaml.obfuscation_context.privacy_algorithm_instance;
    }
