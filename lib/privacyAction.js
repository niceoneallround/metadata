...
following properties:
  ...
  pn_p.encrypt_key_md: [optional] the @id of encrypt key metadata that should always be used with this action.
...
model.utils.YAML2Node = function YAML2Node(yaml, props) {
  ...
  if (yaml.encrypt_key_md) {
    node[PN_P.encryptKeyMD] = yaml.encrypt_key_md;
  }
