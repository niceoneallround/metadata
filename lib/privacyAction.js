...
following properties:
  ...
  pn_p.content_encrypt_key_md: [optional] the @id of encrypt key metadata that should always be used to encrypt/decrypt data with this action.
     If set cannot be overridden at pipe creation time.
  pn_p.key_encrypt_key_md: [optional] the @id of encrypt key metadata that should always be used to encrypt/decrypt/generate content encryption keys
     with this action. If set cannot be overridden at pipe creation time.
  ...
  pn_p.skip_orchestration: If true indicates that the executor should not orchestrate
...
The Privacy Action YAML node has the following format
