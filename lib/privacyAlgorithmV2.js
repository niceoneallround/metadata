...
model.canons.createTestReferenceSourcePrivacyAlgorithm = function createTestReferenceSourcePrivacyAlgorithm(props) {
  'use strict';

  let yaml = {
    id: 'outbound-rspa-testReferenceSource',
    type: 'privacyalgorithm',
    description: 'A valid PA for test reference source schema',
    privacy_step: [{
      id: 'trs-pstep-1',
  ...
  let yaml = {
    ...
    privacy_step: [{
      ...
      privacy_action: [{
        ...
        skip_orchestration: false,
        schema:  {
          $schema: 'http://fake.schema.webshield.io',
          'http//json-schema.org/title': 'http:/fake.schema.webshield.io/type#Subject',
