...
•	pn_p.description
- pn_p.subject_type: the jsonld expanded subject type of the data model
...
const TestQueryPNDataModel = require('data-models/lib/TestQueryPNDataModel');
...
model.canons.createTestPNDataModel = function createTestPNDataModel(props) {
  ...
  let yaml = {
    ...
    subject_type: BaseSubjectPNDataModel.TYPE.Subject,
...
model.canons.createTestReferenceSourcePNDataModel = function createTestReferenceSourcePNDataModel(props) {
  'use strict';
  ...
  let yaml = {
    id: 'subject_records',
    type: 'pndatamodel',
    description: 'A PNDataModel based on the TestReferenceSource model',
    subject_type: TestReferenceSourcePNDataModel.TYPE.Subject,
    json_schema: TestReferenceSourcePNDataModel.model.JSON_SCHEMA,
    jsonld_context: TestReferenceSourcePNDataModel.model.JSONLD_CONTEXT,
    schema_prefix: TestReferenceSourcePNDataModel.model.SCHEMA_PREFIX,
  };
...
model.canons.createTestQueryPNDataModel = function createTestQueryPNDataModel(props) {
  'use strict';
  ...
  let yaml = {
    id: 'query',
    type: 'pndatamodel',
    description: 'A PNDataModel based on the Test Query model',
    subject_type: TestQueryPNDataModel.TYPE.Subject,
    json_schema: TestQueryPNDataModel.model.JSON_SCHEMA,
    jsonld_context: TestQueryPNDataModel.model.JSONLD_CONTEXT,
    schema_prefix: TestQueryPNDataModel.model.SCHEMA_PREFIX,
  };
