...
Is NOT a resource but contained within a either a Reference Source or a Data Connector. It describes a PN data model, and how it should be protected.
...
model.canons.createTestPNDataModel = function createTestPNDataModel(props) {
  ...
  let yaml = {
    id: 'pndatamodel-test-1',
    type: 'pndatamodel',
    description: 'A valid test PNDataModel',
    json_schema: 'add test json schema string',
    jsonld_context: 'add test jsonld context string',
